...
def run_xtb_optimization(input_file, output_file, charge=-4):
...
def main(input_xyz, script_path):
    ...
    optimized_file_2 = "catecholate_solvated_1_optimized.xyz"
    run_xtb_optimization(solvated_file_1, optimized_file_2)

    # Step 5: Add the second solvation layer
    solvated_file_2 = "catecholate_solvated_2.xyz"
    ...
    optimized_file_3 = "catecholate_solvated_2_optimized.xyz"
    run_xtb_optimization(solvated_file_2, optimized_file_3)

    # Step 7: Add the third solvation layer
    solvated_file_3 = "catecholate_solvated_3.xyz"
    ...
    optimized_file_4 = "catecholate_solvated_3_optimized.xyz"
    run_xtb_optimization(solvated_file_3, optimized_file_4)

    # Step 9: Create Gaussian input files for oxidized and reduced forms
    gaussian_files = [
        {"charge": -3, "multiplicity": 2, "title": "Oxidized Structure", "output": "oxidized.com"},
        {"charge": -4, "multiplicity": 1, "title": "Reduced Structure", "output": "reduced.com"}
    ]
