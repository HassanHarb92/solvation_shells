...
def write_gaussian_input(molecule_name, charge, multiplicity, coordinates, state, spin):
    ...
    with open(filename, 'w') as f:
        ...
        f.write("#p uB3LYP empiricaldispersion=gd3 opt=(cartesian,loose,maxcycles=2000,calcfc) scf=(maxcycles=500,xqc,maxconventional=50) cep-31  \n\n")
...
xyz_files = ["catecholate.xyz", "deferipronate.xyz", "kojate.xyz", "maltolate.xyz", "salicylate.xyz"]
