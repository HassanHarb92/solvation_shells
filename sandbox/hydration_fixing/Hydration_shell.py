...
def place_hydrogen_atoms(oxygen_atom, center, oh_distance, angle):
    ...
    # Calculate the direction vector from the metal center to the oxygen atom
    direction = np.array(oxygen_atom) - np.array(center)
    direction /= np.linalg.norm(direction)

    # Generate a perpendicular vector to the direction
