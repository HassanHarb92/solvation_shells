...
def create_frozen_input(filename, frozen_count):
    ...
    with open("deferipronate_frozen.inp", "w") as f:
        f.write("$fix\n")
        f.write(f"  atoms: 1-{frozen_count}\n")
        f.write("$end\n")

def run_xtb_optimization(input_file, output_file, charge=-1, frozen_input="deferipronate_frozen.inp"):
...
def main(input_xyz, script_path):
    ...
    shutil.copy(input_xyz, "deferipronate_original.xyz")
    shutil.copy(input_xyz, "deferipronate_optimized.xyz")
    # Step 4: XTB Optimization on the original structure
    optimized_file_1 = "deferipronate_optimized.xyz"
#    run_xtb_optimization(input_xyz, optimized_file_1)

    # Step 5: Add the first solvation shell
    solvated_file_1 = "deferipronate_solvated_1.xyz"
    ...
    optimized_file_2 = "deferipronate_solvated_1_optimized.xyz"
    run_xtb_optimization(solvated_file_1, optimized_file_2)

    # Step 7: Add the second solvation shell
    solvated_file_2 = "deferipronate_solvated_2.xyz"
    ...
    optimized_file_3 = "deferipronate_solvated_2_optimized.xyz"
    run_xtb_optimization(solvated_file_2, optimized_file_3)

    # Step 9: Add the third solvation shell
    solvated_file_3 = "deferipronate_solvated_3.xyz"
    ...
    optimized_file_4 = "deferipronate_solvated_3_optimized.xyz"
