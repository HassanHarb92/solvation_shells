%chk=Cr_2_BLYP.chk
#p BLYP empiricaldispersion=gd3 6-31+G(2df,p) opt=(cartesian,calcall,maxcycles=500) freq scf=(maxcycles=500,xqc,maxconventional=50)
...
--Link1--
%oldchk=Cr_2_BLYP.chk
%chk=Cr_2_BLYP.chk_solvated
#p BLYP empiricaldispersion=gd3 scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water) geom=allcheck guess=read chkbasis
