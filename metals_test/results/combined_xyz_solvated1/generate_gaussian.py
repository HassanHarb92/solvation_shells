...
xyz_directory = "/path/to/xyz/files"
# Directory to save the .com files
com_directory = "/path/to/com/files"
...
#p {func_name} 6-31+G(2df,p){dispersion} scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water)
