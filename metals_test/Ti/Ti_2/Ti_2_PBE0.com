%chk=Ti_2_PBE0.chk
#p PBE1PBE empiricaldispersion=gd3 6-31+G(2df,p) opt=(cartesian,calcall,maxcycles=500) freq scf=(maxcycles=500,xqc,maxconventional=50)

Title

2 3
Ti                -0.79303724    0.81880520   -0.09490545
...
--Link1--
%oldchk=Ti_2_PBE0.chk
%chk=Ti_2_PBE0.chk_solvated
#p PBE1PBE empiricaldispersion=gd3 scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water) geom=allcheck guess=read chkbasis
