%chk=Ti_3_M08-HX.chk
#p M08HX 6-31+G(2df,p) opt=(cartesian,calcall,maxcycles=500) freq scf=(maxcycles=500,xqc,maxconventional=50)
...
--Link1--
%oldchk=Ti_3_M08-HX.chk
%chk=Ti_3_M08-HX.chk_solvated
#p M08HX scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water) geom=allcheck guess=read chkbasis
