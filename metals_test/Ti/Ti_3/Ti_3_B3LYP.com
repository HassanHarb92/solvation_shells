%chk=Ti_3_B3LYP.chk
#p B3LYP empiricaldispersion=gd3 6-31+G(2df,p) opt=(cartesian,calcall,maxcycles=500) freq scf=(maxcycles=500,xqc,maxconventional=50)
...
--Link1--
%oldchk=Ti_3_B3LYP.chk
%chk=Ti_3_B3LYP.chk_solvated
#p B3LYP empiricaldispersion=gd3 scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water) geom=allcheck guess=read chkbasis
