%chk=Mn_3_svwn.chk
#p svwn 6-31+G(2df,p) opt=(cartesian,calcall,maxcycles=500) freq scf=(maxcycles=500,xqc,maxconventional=50)
...
--Link1--
%oldchk=Mn_3_svwn.chk
%chk=Mn_3_svwn.chk_solvated
#p svwn scf=(maxcycles=500,xqc,maxconventional=50) scrf=(cpcm,solvent=water) geom=allcheck guess=read chkbasis
